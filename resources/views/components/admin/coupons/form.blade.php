...
<div class="grid gap-6">
    ...
    <label class="flex w-fit items-center gap-2 rounded-xl bg-cream-dim px-4 py-3.5 text-sm font-bold text-ink-soft">
        <input type="checkbox" name="is_active" value="1" class="h-4 w-4 rounded accent-accent" @checked(old('is_active', $coupon->is_active ?? true))>
        Active
    </label>
</div>
