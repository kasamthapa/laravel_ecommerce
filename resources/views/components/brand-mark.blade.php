@props(['iconClass' => 'h-5 w-8', 'textClass' => 'font-serif text-2xl tracking-tight text-ink'])
...
<span {{ $attributes->merge(['class' => 'inline-flex items-center gap-2.5']) }}>
    <svg class="{{ $iconClass }} shrink-0 text-accent" viewBox="0 0 40 20" fill="none" aria-hidden="true">
