...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    {{--
        ...
        PDP (products.show), and the cart (cart.index) all get the chosen
        light design system now. Every other storefront page (checkout,
        account, admin) keeps today's dark tokens, completely untouched —
    ...
    --}}
    <body class="storefront {{ request()->routeIs('products.index', 'shop', 'products.show', 'cart.index') ? 'theme-light' : '' }} bg-black font-sans text-bone antialiased">
